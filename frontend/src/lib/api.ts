...
const fallbackData: HomeData = {
  ...
  partners: [
    ["CJDM Digitalized Manufacturing", "industry", "cjdm.webp"],
    ["Dynamic Engineering Steels", "industry", "des.webp"],
    ["GGEAR Group", "industry", "ggear.webp"],
    ["Legrand", "industry", "legrand.webp"],
    ["LG", "industry", "lg.webp"],
    ["Université Sorbonne Paris Nord", "academic", "universite-sorbonne-paris-nord.webp"],
    ["Saint-Gobain", "industry", "saint-gobain.webp"],
    ["Singapore Polytechnic", "academic", "singapore-polytechnic.webp"],
    ["Solar Green Energy Cambodia", "industry", "soge.webp"],
    ["VP.Start", "industry", "vp-start.webp"],
